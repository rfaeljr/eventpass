...
const SelectContent = React.forwardRef<
  ...
  <eact.ComponentPropsWithoutRef<typeof SelectPrimitive.Content>
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popove text-popove-foreground shadow-md",
...
const SelectLabel = React.forwardRef<
 !Ieact.ElementRef<typeof SelectPrimitive.Label>,
